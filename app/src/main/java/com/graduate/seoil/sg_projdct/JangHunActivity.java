...
import com.graduate.seoil.sg_projdct.Retrofit.IMyService;
import com.graduate.seoil.sg_projdct.Retrofit.RetrofitClient;
...
public class JangHunActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jang_hun);
        ...
        txt_craete_account = (TextView)findViewById(R.id.txt_create_account);
        txt_craete_account.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final View register_layout = LayoutInflater.from(JangHunActivity.this)
                            .inflate(R.layout.register_layout, null);

                new MaterialStyledDialog.Builder(JangHunActivity.this)
                            ...
                            .onPositive(new MaterialDialog.SingleButtonCallback() {
                                ...
                                public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                                    ...
                                    if (TextUtils.isEmpty(edt_register_email.getText().toString())) {
                                        Toast.makeText(JangHunActivity.this, "EMail cannot be null or empty", Toast.LENGTH_SHORT).show();
                                        return;
                                    }
                                    if (TextUtils.isEmpty(edt_register_name.getText().toString())) {
                                        Toast.makeText(JangHunActivity.this, "Name cannot be null or empty", Toast.LENGTH_SHORT).show();
                                        return;
                                    }
                                    if (TextUtils.isEmpty(edt_register_password.getText().toString())) {
                                        Toast.makeText(JangHunActivity.this, " Password cannot be null or empty", Toast.LENGTH_SHORT).show();
                                        return;
                                    }
