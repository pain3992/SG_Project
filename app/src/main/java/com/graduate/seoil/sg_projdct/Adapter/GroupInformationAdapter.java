 ...
 */
public class GroupInformationAdapter extends RecyclerView.Adapter<GroupInformationAdapter.ViewHolder> {
    ...
    public GroupInformationAdapter(Context mContext, List<GroupUserList> groupUserLists) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.group_preview_item, viewGroup, false);
